...
if(!empty($_POST["login"])) {
	$result = mysqli_query($conn,"SELECT * FROM admin WHERE suser='" . $_POST["user_name"] . "' and pass = '". $_POST["password"]."'");
...
<form action="master.php" method="post" id="frmLogin">
...
$result = mysqlI_query($conn,"SELECT * FROM admin WHERE suser='" . $_SESSION["user_id"] . "'");
$row  = mysqli_fetch_array($result);
?>
